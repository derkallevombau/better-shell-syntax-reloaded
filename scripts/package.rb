...
# if no language specified, then package the main repo
if language_extension == nil
    # run the build command then package
    system "npm run build && vsce package"
# if an extension was specified
    ...
    begin
        ...
        # run the build command then package
        system "npm run build #{language_extension} && vsce package"
    ensure
