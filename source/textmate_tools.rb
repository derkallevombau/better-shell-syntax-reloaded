...
require_relative('textmate_tools/checkers')
require_relative('textmate_tools/grammar')
require_relative('textmate_tools/pattern_range')
require_relative('textmate_tools/regexp')
require_relative('textmate_tools/token_helper')
